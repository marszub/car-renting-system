...
import { dataToCsv, randomKey, authUrl, rentalUrl, paymentUrl } from './common.js';
import exec from 'k6/execution';
import { sleep } from 'k6';

export function handleSummary (data) {
    return dataToCsv(data, "burst_unrent");
}
...
export default function () {
    ...
    var res = http.post(`${rentalUrl}/api/rental`, rentalPayload, rentalParams).json();

    var paymentPayload = JSON.stringify({
            "email": "ladih79999@prolug.com",
            "rentalId": res["reservationId"]
    });
    ...
    res = http.post(`${paymentUrl}/api/payment`, paymentPayload, paymentParams);
    sleep(10);
}